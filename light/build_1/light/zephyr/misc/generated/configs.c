...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RX_STACK_SIZE, 5120);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_NRFX_UARTE_SPURIOUS_RXTO_WORKAROUND, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBEDTLS_HEAP_SIZE, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_MBEDTLS_BACKEND_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_SECURE_STORAGE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_CRYPTO_KEY_INITIALIZER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_USES_MBEDTLS_PSA, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_SRAM_SIZE, 0x7fc00);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF54LM20DK_NRF54LM20A_CPUAPP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_NRF54LM20A_ENGA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_NRF54LM20A_ENGA_CPUAPP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SETTINGS_ZMS_CUSTOM_SECTOR_COUNT, 1);
