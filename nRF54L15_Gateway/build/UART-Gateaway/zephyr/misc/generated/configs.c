...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBEDTLS_PSA_KEY_SLOT_COUNT, 200);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_CDB_NODE_COUNT, 128);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_CDB_SUBNET_COUNT, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_CDB_APP_KEY_COUNT, 15);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_MODEL_KEY_COUNT, 10);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHELL_BACKEND_DUMMY_BUF_SIZE, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BACKEND_RTT_BUFFER_SIZE, 1024);
